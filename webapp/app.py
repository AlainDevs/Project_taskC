...
def _test_connection():
    # Dummy credentials strictly for unit testing the mock local DB
    test_db_password = "dummy_password_123" # nosemgrep: python.lang.security.hardcoded-secret # nosec
    return True
